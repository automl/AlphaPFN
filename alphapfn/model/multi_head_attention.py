...
from alphapfn.model.save_peak_memory import support_save_peak_mem_factor
    ...
    def compute_attention_heads(  # noqa: C901, PLR0912
        ...
        if TORCH_2_ATTENTION_POSSIBLE:
            ...
            if torch.cuda.is_available():
                ...
                #print("DEBUG_DEVICE", device, flush=True, force=True)
                #print("CUDA_VISIBLE_DEVICES:", os.environ.get("CUDA_VISIBLE_DEVICES"), flush=True, force=True)
                #print("All available devices:", torch.cuda.device_count(), flush=True, force=True)
                #print("Current device index:", torch.cuda.current_device(), flush=True, force=True)
